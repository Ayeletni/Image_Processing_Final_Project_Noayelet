...
The five-image experiment was evaluated at **`b = -0.3`**. The original model on dark images is shown in blue, Gamma-plus-CLAHE in green, and the fine-tuned Mask R-CNN model in orange.
...
The first class-level Gaussian-noise experiment used the five control images at **`STD = 60`**.
